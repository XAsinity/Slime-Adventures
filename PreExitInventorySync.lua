...
-- Registers a pre-exit callback with PlayerProfileOrchestrator to force
...
local Orchestrator = require(script.Parent:WaitForChild("PlayerProfileOrchestrator"))
...
Orchestrator.RegisterPreExitCallback(function(player, profile)
	...
	Orchestrator.MarkDirty(player, "PreExitSync")
end)
